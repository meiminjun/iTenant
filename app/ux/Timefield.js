Ext.define('iTenants.ux.Timefield', {
    extend: 'Ext.field.Text',
    alternateClassName: 'timefield',
    xtype: 'timefield',
    requires: [
        'iTenants.ux.TimePicker',
        'Ext.picker.Date',
        'Ext.DateExtras'
    ],
     ...
     */
    getValue: function () {
        if (this._picker && this._picker instanceof iTenants.ux.TimePicker) {
    ...
    getPicker: function () {
        ...
        if (picker && !picker.isPicker) {
            picker = Ext.factory(picker, iTenants.ux.TimePicker);
            if (value != null) {
