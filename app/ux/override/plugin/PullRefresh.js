 ...
 * @date 20131031
 */
Ext.define('iTenants.ux.override.plugin.PullRefresh', {
    override: 'Ext.plugin.PullRefresh',
    
    requires: [
	   'iTenants.ux.override.Component'
    ],
    ...
    config : {
 	   pullTpl: [
           ...
           '<div class="x-list-pullrefresh-wrap">',
               ...
               '<div class="x-list-pullrefresh-updated">{lastUpdatedText}&nbsp;{[iTenants.util.PubOperation.pullRefreshDataFormat()]}</div>',
           '</div>',
       ].join('')
    },
...
//       me.setViewState('pull');
       ...
       if(me.updatedEl){
    	   me.updatedEl.setHtml(this.getLastUpdatedText() + '&nbsp;' + iTenants.util.PubOperation.pullRefreshDataFormat());
       }
   }
});